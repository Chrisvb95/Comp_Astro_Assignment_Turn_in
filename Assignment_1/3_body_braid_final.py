from amuse.lab import Particles, units, constants
...
def integrate_3body_system(particles, cycle, low_boundary, upper_boundary): #, end_time):
    # This function is used to evolve the 3-body system. 
